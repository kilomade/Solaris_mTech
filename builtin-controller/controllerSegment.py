...
while True:
    ...
    timeCycle = utime.ticks_ms()
    sendCommand("Controller firmware active")
    movementMap = {
    ...
    if(timeCycle - timingMap["movement"]) > config.movementPollingRate:
